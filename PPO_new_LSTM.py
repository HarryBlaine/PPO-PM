...
class PPO(nn.Module):
    def __init__(self, input_size, action_num):
        ...
        self.data = []
        self.fc1 = nn.Linear(input_size, 33)
        self.lstm = nn.LSTM(33, 32)
...
def main():
    ...
    while (n_epi != 3000):
        ...
        while (done == False):
            ...
            if action == most_action and action_counter > t // 4:
                r = r - 0.1
        ...
        Note = open('./DAX_data/training(new).txt', mode='w')
        ...
        if n_epi % 10 == 0:
            ...
            Note_2 = open('./DAX_data/test(new).txt', mode='w')
